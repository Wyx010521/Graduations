...
<!--                <el-input placeholder="请输入昵称" size="medium" style="margin: 5px 0" prefix-icon="" v-model="user.nickname"></el-input>-->
<!--                 </el-form-item>-->
                ...
                <el-form-item style="margin: 5px 0; text-align: right">
                    <el-button type="primary" size="small"  autocomplete="off" @click="resgis">注册</el-button>
